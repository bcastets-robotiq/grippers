...
[How it works](how-it-works.md) first; this page assumes you already
...
[How it works](how-it-works.md) — same `activate()`, `setCommand()`,
...
[Building and running the example](building-and-running.md#cmake-options))
matter here:
