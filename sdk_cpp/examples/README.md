...
- `quick_start` — the minimal connect/activate/move sequence from the
  ...
  handling. Not built as a target; read alongside that guide.
- `move_gripper` — activate, close, and open a gripper through
  `Gripper`'s typed accessors, with error handling and logging. See the
  [walkthrough](../../docs/4-Robust%20example%20walkthrough.md). Built by
  `GRIPPERS_BUILD_EXAMPLES` (see [Environment setup](../../docs/1-Environment%20setup.md)).
